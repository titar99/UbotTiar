...
BOT_TOKEN = os.getenv("BOT_TOKEN", "7393474125:AAEUs5ryH6vriU8R0wcM8qCpX5Gpuv_u_So")
OWNER_ID = int(os.getenv("OWNER_ID", "6708014905"))
LOGS_MAKER_UBOT = int(os.getenv("LOGS_MAKER_UBOT", "-1002234537315"))
